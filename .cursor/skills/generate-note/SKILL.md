...
生成前先读 [templates.md](templates.md)，按其中结构与填写规则写文档。现有说明可参考 `notes/release/ReleaseNotes_v1.1.0.md`。

生成的文档不要包含 `# SVNArchiver` 大标题，从 `## Release Notes` 起头。补充已有文件时若存在该标题则去掉。
